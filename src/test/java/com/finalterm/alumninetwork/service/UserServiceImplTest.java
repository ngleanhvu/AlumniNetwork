...
//
//        when(userRepository.getUserByUsername("anhvu")).thenReturn(Optional.of(mockUser));
//
//        Optional<User> user = userService.getUserByUsername("anhvu");
//
//        assertTrue(user.isPresent());
//        assertEquals("anhvu@gmail.com", user.get().getEmail());
//    }
//
//    @Test
//    @Tag("getUser")
